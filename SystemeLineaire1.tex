...
\chapter{ Analyse d'une commande proportionnelle intégrales}
 ...
 \begin{center}
    \includegraphics[scale=0.8]{bode1.png}
    \captionof{figure}{\textit{Diagramme de Bode de K(jw), avec: $\tau_{i}=1.115$ et K=0.38 }}
    \label{fig2}
   \end{center}
...
\begin{center}
 \includegraphics[scale=0.8]{figure4.png}
    \captionof{figure}{\textit{diagramme de Bode qui englobe les Gabarit}}
   \label{fig1}
   \end{center}
   
   \begin{center}
    \includegraphics[scale=0.8]{figure5.png}
    \captionof{figure}{\textit{Diagramme de Bode de la fonction de sensibilité en final}}
    \label{fig1}
   \end{center}
