...
\captionof{figure}{\textit{simulation du modèle non linéaire.\\}}
\label{fig1} 
\end{center} 
...
\captionof{figure}{\textit{simulation du dispositif linéaire  .\\}}
\label{fig1} 
\end{center}
...
\captionof{figure}{\textit{simulation du dispositif linéaire supérieur.\\}}
\label{fig1} 
\end{center}
